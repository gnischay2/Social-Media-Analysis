...
public void init() {
 setSize(1000,300);
	...
	c=new Checkbox[20];
	l=new Label[10];
        tf[1]=new TextField("Enter Facebook username");
...
//if(str2.equals("username")) {msg2="username";}
        if(str2.equals("friends")){msg2="friends";col2=1;}
	if(str2.equals("post")){msg2="post";col2=2;}
	if(str2.equals("time")){msg2="time";col2=3;}
	if(str2.equals("like")){msg2="like";col2=4;}
	if(str2.equals("comment")){msg2="comment";col2=5;}
	if(str2.equals("share")){msg2="share";col2=6;}
...
try {
    Process p = Runtime
                    .getRuntime()
                    .exec("cmd /c start cmd.exe /K \"python fbgraph.py\"");
    } catch (IOException e) {
