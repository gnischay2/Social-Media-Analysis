...
*/
public class instagram extends Applet implements ActionListener,ItemListener {
String str;
int col1=0,col2=0;
Button b[];
CheckboxGroup g[];
...
public void init() {
	...
	c=new Checkbox[20];
	l=new Label[10];
        tf[1]=new TextField("Enter Instagram username");
	...
	c[4]=new Checkbox("favourites",g[1],false);
	c[5]=new Checkbox("time",g[1],false);
	c[6]=new Checkbox("like",g[1],false);
...
//	c[8]=new Checkbox("username",g[2],false);
	...
	c[11]=new Checkbox("favourites",g[2],false);
	c[12]=new Checkbox("time",g[2],false);
	c[13]=new Checkbox("like",g[2],false);
...
try{	
	...
	if(str1.equals("favourites")){msg1="favourites";col1=3;}
	if(str1.equals("time")){msg1="time";col1=4;}
	if(str1.equals("like")){msg1="like";col1=5;}
	...
	if(str2.equals("favourites")){msg2="favourites";col2=3;}
	if(str2.equals("time")){msg2="time";col2=4;}
	if(str2.equals("like")){msg2="like";col2=5;}
