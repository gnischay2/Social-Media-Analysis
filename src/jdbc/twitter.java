...
*/
public class twitter extends Applet implements ActionListener,ItemListener {
String str;
int col1=0,col2=0;
Button b[];
CheckboxGroup g[];
...
public void init() {
 setSize(1000,300);
	...
	c=new Checkbox[20];
	l=new Label[10];
        tf[1]=new TextField("Enter Twitter username");
	...
	c[2]=new Checkbox("followers",g[1],false);
	c[3]=new Checkbox("following",g[1],false);
	c[4]=new Checkbox("tweet_id",g[1],false);
	c[5]=new Checkbox("time",g[1],false);
	c[6]=new Checkbox("retweet",g[1],false);
	//c[7]=new Checkbox("comment",g[1],false);
//	c[8]=new Checkbox("username",g[2],false);
	c[9]=new Checkbox("followers",g[2],false);
	c[10]=new Checkbox("following",g[2],false);
	c[11]=new Checkbox("tweet_id",g[2],false);
	c[12]=new Checkbox("time",g[2],false);
	c[13]=new Checkbox("retweet",g[2],false);
	//c[14]=new Checkbox("comment",g[2],false);
	...
	setLayout(null);
        add(tf[1]);
        tf[1].setBounds(400,5,250,20);
        add(l[1]);
	l[1].setBounds(20,40,100,50);
	
  //      add(c[1]);
//	c[1].setBounds(150,20,100,50);
	add(c[2]);
	c[2].setBounds(300,40,100,50);
	add(c[3]);
	c[3].setBounds(400,40,100,50);
	add(c[4]);
	c[4].setBounds(500,40,100,50);
	add(c[5]);
	c[5].setBounds(600,40,100,50);
	add(c[6]);
	c[6].setBounds(700,40,100,50);
	//add(c[7]);
...
//	if(str1.equals("username")){msg1="username";}
        if(str1.equals("followers")){msg1="followers";col1=1;}
	if(str1.equals("following")){msg1="following";col1=2;}
	if(str1.equals("tweet_id")){msg1="tweet_id";col1=3;}
	if(str1.equals("time")){msg1="time";col1=4;}
	if(str1.equals("retweet")){msg1="retweet";col1=5;}
	//if(str1.equals("comment")){msg1="comment";col1=6;}
	
	
//	if(str2.equals("username")){msg2="username";}
	if(str2.equals("followers")){msg2="followers";col2=1;}
	if(str2.equals("following")){msg2="following";col2=2;}
	if(str2.equals("tweet_id")){msg2="tweet_id";col2=3;}
	if(str2.equals("time")){msg2="time";col2=4;}
	if(str2.equals("retweet")){msg2="retweet";col2=5;}
	//if(str2.equals("comment")){msg2="comment";col2=6;}
...
try {
    Process p = Runtime
                    .getRuntime()
                    .exec("cmd /c start cmd.exe /K \"python twittergraph.py\"");
    } catch (IOException e) {
